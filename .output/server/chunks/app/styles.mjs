...
const styles = {
  "pages/add.vue": () => import('./_nuxt/add-styles.f593202d.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.212221cb.mjs').then(interopDefault),
  ...
  "layouts/default.vue": () => import('./_nuxt/default-styles.1448f12a.mjs').then(interopDefault)
};
